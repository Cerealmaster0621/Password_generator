...
** Modifier^(entire password - required string) / 10^9 * weight*5
*/
...
void TimeCalc::print_time(uint64_t time){
    double seconds_per_day = 86400, seconds_per_month = 86400*30, seconds_per_year = 86400*30*12, seconds_per_century = 3155673600;
